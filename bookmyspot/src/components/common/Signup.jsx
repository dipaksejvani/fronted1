  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const roleId = userRole === 'user' 
        ...
        : '67cfb7c6290b3ce5f32524d8'; // Organizer role ID
        ...
        <div style={{
          ...
          <div style={{
            ...
            <form onSubmit={handleSubmit(onSubmit)} noValidate>
              ...
              <div style={{marginBottom: '20px'}}>
                ...
                <div style={{
                  ...
                  >
                    ...
                    <span style={{color: '#333', fontSize: '14px'}}>Organizer/Venue Provider</span>
                  </div>
                </div>
              ...
              {isLoading && <p style={{color: '#6c757d', fontSize: '14px', textAlign: 'center', marginBottom: '20px'}}>Setting up your account...</p>}

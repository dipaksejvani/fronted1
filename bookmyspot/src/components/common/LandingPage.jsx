...
import { FaSearch, FaMapMarkerAlt, FaChevronDown, FaQuestionCircle, FaCalendarAlt, FaUsers, FaHeart, FaFilter, FaSlidersH, FaArrowUp } from 'react-icons/fa';
            ...
            <div className="collapse navbar-collapse" id="navbarContent">
              ...
              <ul className="navbar-nav ms-auto align-items-center gap-3">
                <li className="nav-item">
                  <Link to="/organize" className="nav-link d-flex align-items-center">
                    <FaCalendarAlt className="d-lg-none me-2" aria-hidden="true" />
...
const TestimonialsSection = () => (
  <section className="testimonials_section py-5" style={{ position: 'relative' }}>
    <div className="container-fluid">
      <div className="text-center mb-5">
      ...
      {/* Hide all carousel navigation controls */}
      <style>
        {`
          ...
          <div className="col-lg-4 col-md-6" key={index}>
            <div className="card h-100 border-0 shadow-sm testimonial-card p-4">
              ...
              <div className="d-flex align-items-center mt-auto">
                <img src={testimonial.image} alt="" className="rounded-circle me-3" width="50" height="50" style={{objectFit: "cover"}} /> {/* Alt is empty because image is decorative */}
                <div>
    ...
    <div className="container-fluid">
      ...
      <div className="row">
        <div className="col-12 text-center">
          <p className="mb-0">© 2023 BookMySpot. All rights reserved.</p>
        </div>
      </div>
    </div>
  </footer>

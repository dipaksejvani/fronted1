...
export const AddPlace = () => {
  ...
  const submitHandler = async (data) => {
    ...
    const res = await axios.post("/event/addplace", data);
      ...
      <div className="row justify-content-center">
        <div className="col-md-8">
          <div className="card p-4 shadow">
            <h2 className="text-center mb-4">Add Place</h2>
            <form onSubmit={handleSubmit(submitHandler)}>
              <div className="mb-3">
                <label className="form-label">Hoarding</label>
                <input type="text" className="form-control" {...register("eventDimension")} />
              </div>
              <div className="mb-3">
